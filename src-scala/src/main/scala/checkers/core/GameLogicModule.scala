...
trait GameLogicModule {
  ...
  def performanceClock: PerformanceClock
}
...
class GameLogicModuleFactory(tablesModule: TablesModule,
                             ...
                             performanceClock: PerformanceClock) extends (RulesSettings => GameLogicModule) {
  ...
  def apply(rulesSettings: RulesSettings): GameLogicModule = {
    ...
    val myPerformanceClock = performanceClock
    ...
    new DefaultGameLogicModule {
      ...
      override lazy val performanceClock: PerformanceClock = myPerformanceClock
    }
  }
